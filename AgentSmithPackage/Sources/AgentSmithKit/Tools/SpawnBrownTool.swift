...
public struct SpawnBrownTool: AgentTool {
    ...
    public let toolDescription = "Spawn a new Brown agent (with a paired Jones safety monitor). Returns the Brown agent's ID. Send task instructions separately via send_message."
